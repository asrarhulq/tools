 ...
 */ !(function () {
  ...
  function t() {
    function e(e) {
        ...
        L =
          (W
            ? ((p = l ? require("path").dirname(p) + "/" : __dirname + "/"),
              (k = () => {
                r || ((H = require("fs")), (r = require("path")));
              }),
              (n = function (e, n) {
                return (
                  k(),
                  (e = r.normalize(e)),
                  H.readFileSync(e, n ? void 0 : "utf8")
                );
              }),
              ...
              (c = (e, n) => {
                ...
                (n instanceof Y || d("exiting due to exception: " + n),
                  process.exit(e));
              }),
              (f.inspect = function () {
      ...
      function ae() {
        var e = w;
        try {
          if (e == w && i) return new Uint8Array(i);
          if (t) return t(e);
      ...
      ((f.preloadedImages = {}),
        (f.preloadedAudios = {}),
        (w = "stockfish.wasm"),
        oe() || ((o = w), (w = f.locateFile ? f.locateFile(o, p) : p + o)));
      var ie = {
        6678104: function () {
          try {
            f.onDoneSearching();
      ...
      function he() {
        if (!de) {
          ...
          for (e in me) void 0 === me[e] ? delete n[e] : (n[e] = me[e]);
          var t = [];
      ...
      function ge(e, n, t, r) {
        ...
        var f,
          ...
          l = {
            ...
            "%I": function (e) {
              return (0 == (e = e.M) ? (e = 12) : 12 < e && (e -= 12), a(e, 2));
            },
            "%j": function (e) {
              return a(e.L + ye(M(e.A + 1900) ? x : R, e.K - 1), 3);
            },
            "%m": function (e) {
              return a(e.K + 1, 2);
            },
            ...
            "%U": function (e) {
              var n = new Date(e.A + 1900, 0, 1),
                t = 0 === n.getDay() ? n : C(n, 7 - n.getDay());
              return i(t, (e = new Date(e.A + 1900, e.K, e.L))) < 0
                ? a(
                    Math.ceil(
                      (31 -
                        t.getDate() +
                        (ye(M(e.getFullYear()) ? x : R, e.getMonth() - 1) -
                          31) +
                        e.getDate()) /
                        7,
                    ),
          ...
          (0 === E
            ? ((a = o = !1),
              e(() => {
                if (!v && ((o = !0), a)) {
                  ((E = 2),
                    F(() => f._asyncify_start_rewind(O)),
                    "undefined" != typeof Browser &&
                      Browser.R.S &&
                      Browser.R.resume());
                  var n = !1;
                  try {
                    var t = (0, f.asm[we[g[(O + 8) >> 2]]])();
                  } catch (e) {
                    ((t = e), (n = !0));
                  }
                  var e,
              ...
              o ||
                ...
                (g[(e + 8) >> 2] = t),
                (O = e),
                F(() => f._asyncify_start_unwind(O)),
                "undefined" != typeof Browser &&
                  Browser.R.S &&
                  Browser.R.pause()))
            : 2 === E
              ? ((E = 0),
                F(f._asyncify_stop_rewind),
                xe(O),
                (O = null),
                Se.forEach((e) => pe(e)))
              : A("invalid state: " + E));
      ...
      var I,
        Me = {
          ...
          j: function (e, n, t) {
            var r;
            for (fe.length = 0, t >>= 2; (r = y[n++]);)
              ((r = r < 105) && 1 & t && t++,
                fe.push(r ? N[t++ >> 1] : g[t]),
                ++t);
            return ie[e].apply(null, fe);
          },
          h: function (e, n, t) {
          ...
          c: function (e) {
            ...
            if (!(2147483648 < (e >>>= 0)))
              for (var t = 1; t <= 4; t *= 2) {
                ...
                e: {
                  try {
                    (q.grow((o - B.byteLength + 65535) >>> 16), Z());
                    var a = 1;
                    break e;
                  } catch (e) {}
                  a = void 0;
        ...
        xe =
          (!(function () {
            ...
            function r(e) {
              return (
                ...
                .then(e, function (e) {
                  (d("failed to asynchronously prepare wasm: " + e), A(e));
                });
            }
            var o = { a: Me };
            if (
          ...
          (f.___wasm_call_ctors = function () {
            return (f.___wasm_call_ctors = f.asm.t).apply(null, arguments);
          }),
          (f._main = function () {
            return (f._main = f.asm.u).apply(null, arguments);
          }),
          (f._command = function () {
            return (f._command = f.asm.v).apply(null, arguments);
          }),
          (f._isSearching = function () {
            return (f._isSearching = f.asm.w).apply(null, arguments);
          }),
          (f._free = function () {
            return (xe = f._free = f.asm.x).apply(null, arguments);
          })),
        Re = (f.___errno_location = function () {
          return (Re = f.___errno_location = f.asm.y).apply(null, arguments);
        }),
        Ce = (f._malloc = function () {
          return (Ce = f._malloc = f.asm.z).apply(null, arguments);
        }),
        Fe = (f.stackSave = function () {
          return (Fe = f.stackSave = f.asm.B).apply(null, arguments);
        }),
        Ee = (f.stackRestore = function () {
          return (Ee = f.stackRestore = f.asm.C).apply(null, arguments);
        }),
        P = (f.stackAlloc = function () {
          return (P = f.stackAlloc = f.asm.D).apply(null, arguments);
        }),
        Oe = (f.dynCall_vi = function () {
          return (Oe = f.dynCall_vi = f.asm.E).apply(null, arguments);
        }),
        Te = (f.dynCall_v = function () {
          return (Te = f.dynCall_v = f.asm.F).apply(null, arguments);
        });
      function Y(e) {
          ...
          if (!I && ((I = !0), (f.calledRun = !0), !v)) {
            ...
            if (f.postRun)
              for (
                ...
                ((e = f.postRun.shift()), ne.unshift(e));
            D(ne);
          }
        }
        if (((a = a || u), !(0 < b))) {
          if (f.preRun)
            for (
              ...
              ((n = void 0), (n = f.preRun.shift()), $.unshift(n));
          (D($),
            0 < b ||
              (f.setStatus
                ? (f.setStatus("Running..."),
      ...
      if (
        ((f._asyncify_start_unwind = function () {
          return (f._asyncify_start_unwind = f.asm.G).apply(null, arguments);
        }),
        (f._asyncify_stop_unwind = function () {
          return (f._asyncify_stop_unwind = f.asm.H).apply(null, arguments);
        }),
        (f._asyncify_start_rewind = function () {
          return (f._asyncify_start_rewind = f.asm.I).apply(null, arguments);
        }),
        (f._asyncify_stop_rewind = function () {
          return (f._asyncify_stop_rewind = f.asm.J).apply(null, arguments);
        }),
          ...
          var i = {
              string: function (e) {
                ...
                return (
                  null != e &&
                    0 !== e &&
                    ((n = 1 + (e.length << 2)), (t = P(n)), G(e, y, t, n)),
                  t
                );
              },
              array: function (e) {
        ...
        for (
          ...
          f.preInit.pop()();
      var Ye = !0;
      return (f.noInitialRun && (Ye = !1), Ie(), e.ready);
    }
    var je;
    ((je =
      "undefined" != typeof document && document.currentScript
        ...
        : void 0),
      "undefined" != typeof __filename && (je = je || __filename));
    return (
  ...
  function a() {
    for (; n.length && (!c._isSearching || !c._isSearching());) o(n.shift());
  }
  function i(e) {
  ...
  function f() {
    if (c._isReady && !c._isReady()) return setTimeout(f, 10);
    var t;
    ("undefined" == typeof IS_ASYNCIFY
      ? (c.onDoneSearching = a)
      : (c.onDoneSearching = function () {
          setTimeout(a, 1);
        }),
      (c.processCommand = i),
      r.length &&
                ...
                !(function t() {
                  n.read()
                    .then(function (e) {
                      ...
                      n
                        ? (u(i, o, o), r.close())
                        : ((a += e.byteLength), u(i, a, o), r.enqueue(e), t());
                    })
                    .catch(function e(n) {
                      (r.error(n), e(n));
                    });
    ...
    ((c = {
      ...
      instantiateWasm: function (n, t) {
        ...
        return a(u, e)
          ...
          .then(function (e) {
            return (t(e.instance, e.module), e.instance.exports);
          })
          .catch(function (e) {
            throw (console.error("WASM streaming failed:", e), e);
          });
      },
    }),
      t()(c)
        ...
        e
          ? require.main === module
            ? ((e = require("path")),
              (u = e.join(
                __dirname,
                e.basename(__filename, e.extname(__filename)) + ".wasm",
              )),
              (c = {
                locateFile: function (e) {
                  return -1 < e.indexOf(".wasm")
              ...
              require("readline")
                ...
                .on("line", function (e) {
                  e &&
                    (c.processCommand ? c.processCommand(e) : r.push(e),
                    "quit" === e) &&
                    process.exit();
                })
                .on("close", function () {
          ...
          : ((e = self.location.hash.substr(1).split(",")),
            ...
            (onmessage =
              onmessage ||
              function (e) {
                if ("setoption name CanOutputEngineDownloadProgress" === e.data)
                  postMessage("info WillOutputEngineDownloadProgress");
                else if (e.data.progressPort) s = e.data.progressPort;
                else if (
                  (c.processCommand ? c.processCommand(e.data) : r.push(e.data),
                  "quit" === e.data)
                )
                  try {
                    self.close();
